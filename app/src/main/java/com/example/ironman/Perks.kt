...
var perks = mutableMapOf<String, Perks>(
    ...
    "Dodatkowy atak na rundę" to Perks("Dodatkowy atak na rundę", "Atut ten pozwala na wykonanie dodatkowego ataku podczas rundy bochatera",{ player.attackPerRound += 1 },{ player.attackPerRound -= 1}) ,
